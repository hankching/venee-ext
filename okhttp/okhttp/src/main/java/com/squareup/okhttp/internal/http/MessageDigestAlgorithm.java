...
public class MessageDigestAlgorithm {
    ...
    public static  String calculateResponse(String algorithm, String hashUserNameRealmPasswd,
        ...
        {
            request_digest = KD(hashUserNameRealmPasswd, nonce_value + ":" + nc_value
    ...
    public static  String calculateResponse(String algorithm, String username_value,
            String realm_value, String passwd, String nonce_value, String nc_value,
            String cnonce_value, String method, String digest_uri_value,
