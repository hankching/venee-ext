...
static int wpa_cli_mcmd_vendor_elem_add(struct wpa_ctrl *ctrl, int argc,
					char *argv[])
{
	return wpa_cli_cmd(ctrl, "VENDOR_ELEM_ADD", 0, argc, argv);
}

static int wpa_cli_mcmd_vendor_elem_remove(struct wpa_ctrl *ctrl, int argc,
					char *argv[])
{
	return wpa_cli_cmd(ctrl, "VENDOR_ELEM_REMOVE", 0, argc, argv);
}
...
static const struct wpa_cli_cmd wpa_cli_commands[] = {
	...
	{ "vendor_elem_add", wpa_cli_mcmd_vendor_elem_add, NULL,
	  cli_cmd_flag_none,
	  "vendor_elem_add" },
	{ "vendor_elem_remove", wpa_cli_mcmd_vendor_elem_remove, NULL,
	  cli_cmd_flag_none,
	  "vendor_elem_remove" },
#endif /* CONFIG_P2P */
#ifdef CONFIG_WIFI_DISPLAY
...
#ifdef CONFIG_MTK_P2P  /* [ALPS00618361] [WFD Quality Enhancement] */
	{ "get_sta_statistics",
	  wpa_cli_cmd_testmode_get_sta_statistics, NULL, cli_cmd_flag_none,
