...
#define P2P_GO_NEG_RSP_MAX_RETRY_COUNT 5
#else
...
#ifdef CONFIG_MTK_P2P
#define P2P_DEV_SD_INFO BIT(23)
#define P2P_DEV_SD_SCHEDULE BIT(24)
#endif
	...
	/**
	 * freq - Frquency on which the GO Negotiation Response is sent
	 */
...
struct p2p_data {
...
#ifdef CONFIG_MTK_P2P
	struct p2p_pending_action_tx *after_sd_tx;
#endif
	...
	*/
	int in_beam_scan;
	/*
	* P2P Beam Plus GO reserve.
	* Reserve channel and skip legacy wlan scan
	*/
...
void p2p_update_peer_vendor_elems(struct p2p_device *dev, const u8 *ies,
					 size_t ies_len);
int mtk_channel_to_freq(int channel);
#endif
/* p2p_group.c */
