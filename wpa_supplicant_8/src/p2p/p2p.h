...
#if defined (CONFIG_MTK_P2P) || defined (CONFIG_MTK_SCC)
...
int wfd_scan_result_text(const u8 *ies, size_t ies_len,
			char *buf, char *end);
void
...
int wpas_wfd_scan_result_text(const u8 *ies,
