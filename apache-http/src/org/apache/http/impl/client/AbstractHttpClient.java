...
public abstract class AbstractHttpClient implements HttpClient {
    ...
    */
    ...
    private static Method sendingTrafficPermittedByMomMethod;

    private boolean isAllowSendByMom(int checkType) {
        // TODO: Remove this method once NetworkSecurityPolicy can be accessed without Reflection.
        // This method invokes NetworkSecurityPolicy.getInstance().isSendingTrafficPermittedByMom
        // via Reflection API.
        ...
        try {
            ...
            return (Boolean) method.invoke(policy, checkType);
