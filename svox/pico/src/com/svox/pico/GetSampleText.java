...
public class GetSampleText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**M: To check whether the current system language is same as TTS engine's.@{**/
        Locale sysLocale = Locale.getDefault();
        String sysLanguage = sysLocale.getISO3Language();
        if (language != null && language.equals(sysLanguage)) {
            if (language.equals("eng") && country != null) {
